...
<body class="font-sans bg-void">
    <div class="min-h-screen flex items-center justify-center px-6 py-14">
        <div class="w-full max-w-sm motion-safe:animate-fade-up">
            ...
            <form method="POST" action="/ranksol/login" class="space-y-5">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('platform.password.request') }}" class="text-xs text-mist hover:text-ink transition">Forgot password?</a>
                    </div>
            ...
            <p class="text-xs text-mist mt-10 text-center">RankSol staff only · not for gym owners or members</p>
        </div>
    </div>
</body>
</html>
