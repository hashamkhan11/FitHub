...
<head>
    ...
    <title>FitHub Admin — Reset password</title>
    ...
    <div class="min-h-screen lg:grid lg:grid-cols-5">
        ...
        <div class="relative lg:col-span-3 min-h-[42vh] lg:min-h-screen flex flex-col justify-between overflow-hidden bg-void">
            ...
            <div class="relative p-8 lg:p-12 pb-14 lg:pb-16 max-w-xl motion-safe:animate-fade-up" style="animation-delay: 120ms">
                ...
                <h1 class="font-display font-semibold text-4xl lg:text-5xl leading-[1.05] tracking-tight text-balance text-ink mb-5">
                    Choose a new<br class="hidden lg:block"> password.
                </h1>
                <p class="text-steel-2 text-sm lg:text-base leading-relaxed mb-8 max-w-md">
                    This link is single-use and expires shortly, so finish setting your new password now.
                </p>
            </div>
        </div>
        ...
        <div class="lg:col-span-2 flex items-center justify-center bg-chalk px-6 py-14 sm:px-12">
            <div class="w-full max-w-sm motion-safe:animate-fade-up" style="animation-delay: 180ms">
                <p class="fh-eyebrow mb-2">Reset password</p>
                <h2 class="fh-heading text-2xl mb-8">Set a new password</h2>
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input class="fh-input" type="email" name="email" id="email" value="{{ old('email', $email) }}" required autofocus>
                    </div>

                    <div>
                        <label class="fh-label" for="password">New password</label>
                        <input class="fh-input" type="password" name="password" id="password" required minlength="8">
                    </div>

                    <div>
                        <label class="fh-label" for="password_confirmation">Confirm new password</label>
                        <input class="fh-input" type="password" name="password_confirmation" id="password_confirmation" required minlength="8">
                    </div>

                    <button class="fh-btn-primary w-full !py-3" type="submit">Reset password</button>
                </form>
