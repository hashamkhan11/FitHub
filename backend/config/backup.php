...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 *
                 * Application code is already in git, so only the database (below) and
                 * locally-stored user uploads (member photos, etc.) need backing up here.
                 */
                'include' => [
    ...
    'notifications' => [
        'notifications' => [
            // Only failures/problems email out — daily success emails for a
            // job that's expected to succeed would just be inbox noise.
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'hashammubarak1@gmail.com'),
